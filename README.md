# Donchian Channel Breakout: Detailed Drawdown & Advanced Indicator Suite
...
- *Donchian Channel Breakout Strategy:*  
  Automatically generates trade signals based on historical highs and lows.
  
- *Detailed Drawdown Analysis:*  
  Visualizes maximum drawdowns, recovery periods, and other risk metrics.
  
- *Advanced Indicator Filters:*  
  Optionally filter signals using:
...
- *Dynamic User Inputs:*  
  All extra filters have configurable thresholds and periods directly via the sidebar.
...
- *Processing:*  
  The data was cleaned and normalized to account for corporate actions such as bonuses, splits, and rights.
- *Time Period:*  
